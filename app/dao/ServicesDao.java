...
public class ServicesDao {
    ...
    public List<HomeQuote> getQuotesForPostcode(String postCode) {
        HomeQuote[] homeInsuranceQuotes = {
                new HomeQuote("Buildings Cover", 94.95, true, false, true, 400,                 "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover & Contents", 105.95, true, false, true, 400,     "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover", 124.95, false, false, true, 400,               "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover", 130.95, true, true, false, 350,                "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover", 140.95, true, false, true, 200,                "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover", 145.95, true, false, true, 300,                "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover", 155.95, true, false, true, 450,                "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover", 180.95, true, false, true, 500,                "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover", 194.95, true, false, true, 450,                "http://msmeco.co.uk/home-details"),
                new HomeQuote("Buildings Cover & Contents", 294.95, true, false, true, 200,     "http://msmeco.co.uk/home-details"),
        };
